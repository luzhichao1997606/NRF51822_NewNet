...
#define RF_BUFFER_SIZE                              10

#define RF_SENDFSK_WAKE_SIGNAL_TIME                 400
#define RF_SENDLORA_WAKE_SIGNAL_TIME                10
...
extern volatile uint16 TickCounter;
//extern uint8 RFBuffer[RF_BUFFER_SIZE];
extern uint16 RxPacketSize;
extern uint8 SyncWord;
extern  bool LoRaOn ;
//extern uint32 u32RfPreWorkTime;
//extern uint8 u8RfAddr[6];
//extern uint16 u8SendWakeSignalTimer ;
//extern en_RF_FLG u8RfWorkFlg ;

//extern uint16 u8RfSendTime;
 ...
 */
void SX1276GetRxPacket( void *buffer, uint8 *size );
 ...
 * \param [IN]: size       Buffer size
 */
void SX1276SetTxPacket( const void *buffer, uint16 size );
 ...
 */
void SX1276SetRFState( uint8 state );
