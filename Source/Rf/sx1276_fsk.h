...
#define RF_RSSITHRESH_THRESHOLD                    220  // -/2

#define RF_RSSI_TIMEOUT1                           0 
#define RF_PREABLE_TIMEOUT2                       2//8bytes
#define RF_SYNC_TIMEOUT3                          0 //12bytes
/*!
...
#define RF_OPMODE_MODULATIONTYPE_NONE                0x40
...
typedef struct sSX1276
{
    ...
    uint8 RegBitrateMsb;                          // 0x02
    uint8 RegBitrateLsb;                          // 0x03
    uint8 RegFdevMsb;                             // 0x04
    uint8 RegFdevLsb;                             // 0x05
    ...
    // Rx settings
    uint8 RegLna;                                 // 0x0C
    uint8 RegRxConfig;                            // 0x0D
    uint8 RegRssiConfig;                          // 0x0E
    uint8 RegRssiCollision;                       // 0x0F
    uint8 RegRssiThresh;                          // 0x10
    uint8 RegRssiValue;                           // 0x11
    uint8 RegRxBw;                                // 0x12
    uint8 RegAfcBw;                               // 0x13
    uint8 RegOokPeak;                             // 0x14
    uint8 RegOokFix;                              // 0x15
    uint8 RegOokAvg;                              // 0x16
    uint8 RegRes17;                               // 0x17
    uint8 RegRes18;                               // 0x18
    uint8 RegRes19;                               // 0x19
    uint8 RegAfcFei;                              // 0x1A
    uint8 RegAfcMsb;                              // 0x1B
    uint8 RegAfcLsb;                              // 0x1C
    uint8 RegFeiMsb;                              // 0x1D
    uint8 RegFeiLsb;                              // 0x1E
    uint8 RegPreambleDetect;                      // 0x1F
    uint8 RegRxTimeout1;                          // 0x20
    uint8 RegRxTimeout2;                          // 0x21
    uint8 RegRxTimeout3;                          // 0x22
    uint8 RegRxDelay;                             // 0x23
    // Oscillator settings
    uint8 RegOsc;                                 // 0x24
    // Packet handler settings
    uint8 RegPreambleMsb;                         // 0x25
    uint8 RegPreambleLsb;                         // 0x26
    uint8 RegSyncConfig;                          // 0x27
    uint8 RegSyncValue1;                          // 0x28
    uint8 RegSyncValue2;                          // 0x29
    uint8 RegSyncValue3;                          // 0x2A
    uint8 RegSyncValue4;                          // 0x2B
    uint8 RegSyncValue5;                          // 0x2C
    uint8 RegSyncValue6;                          // 0x2D
    uint8 RegSyncValue7;                          // 0x2E
    uint8 RegSyncValue8;                          // 0x2F
    uint8 RegPacketConfig1;                       // 0x30
    uint8 RegPacketConfig2;                       // 0x31
    uint8 RegPayloadLength;                       // 0x32
    uint8 RegNodeAdrs;                            // 0x33
    uint8 RegBroadcastAdrs;                       // 0x34
    uint8 RegFifoThresh;                          // 0x35
    // Sequencer settings
    uint8 RegSeqConfig1;                          // 0x36
    uint8 RegSeqConfig2;                          // 0x37
    uint8 RegTimerResol;                          // 0x38
    uint8 RegTimer1Coef;                          // 0x39
    uint8 RegTimer2Coef;                          // 0x3A
    // Service settings
    uint8 RegImageCal;                            // 0x3B
    uint8 RegTemp;                                // 0x3C
    uint8 RegLowBat;                              // 0x3D
    // Status
    uint8 RegIrqFlags1;                           // 0x3E
    uint8 RegIrqFlags2;                           // 0x3F
    // I/O settings
    ...
    // Test
    uint8 RegTestReserved6D[0x70 - 0x6D];         // 0x6D-0x6F
    // Additional settings
    uint8 RegBitrateFrac;                         // 0x70
}tSX1276;
 ...
 */
void SX1276FskSetLoRaOn( uint8 enable );
 ...
 */
void SX1276FskGetRxPacket( void *buffer, uint16 *size );
 ...
 * \param [IN]: size       Buffer size
 */
void SX1276FskSetTxPacket( const void *buffer, uint16 size );
 ...
 */
uint8 SX1276FskGetRFState( void );
 ...
 */
void SX1276FskSetRFState( uint8 state );
 ...
 */
uint32 SX1276FskGetRFFrequency( void );
 ...
 */
uint32 SX1276FskGetBitrate( void );
 ...
 */
uint32 SX1276FskGetBw( uint8* reg );
 ...
 */
void SX1276FskSetPacketCrcOn( uint8 enable );
 ...
 */
uint8 SX1276FskGetPacketCrcOn( void );
 ...
 */
void SX1276FskSetPayloadLength( uint8 value );
 ...
 */
uint8 SX1276FskGetPayloadLength( void );
 ...
 */
//uint8 SX1276FskGetPa20dBm( void );
 ...
 */
void SX1276FskSetPreambleSize( uint16 size );
 ...
 */
int8 SX1276FskCalibreateTemp( int8 actualTemp );
 ...
 */
int8 SX1276FskGetTemp( int8 compensationFactor );

void SX1276FskTestRx(void);

void SX1276FskTestTx(void);
void SX1276FskSlp(void);
void SX1276FskDetectRadio(void);
