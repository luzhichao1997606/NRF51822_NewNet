...
/*  SPI0 */
#define SPI_PSELSCK0              27   /*!< GPIO pin number for SPI clock (note that setting this to 31 will only work for loopback purposes as it not connected to a pin) */
...
#define SPI_PSELSS0               26   /*!< GPIO pin number for Slave Select           */

/*  SPI1 */
#define SPI_PSELSCK1              06   /*!< GPIO pin number for SPI clock              */
#define SPI_PSELMOSI1             04   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO1             05   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS1               07   /*!< GPIO pin number for Slave Select           */
